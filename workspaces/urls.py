...
from .api import (
    workspace_archive_api,
    workspace_current_api,
    workspace_list_api,
    workspace_transfer_ownership_api,
)
...
urlpatterns = [
    ...
    path("api/workspaces/current/archive/", workspace_archive_api, name="workspace-archive"),
    path("api/workspaces/current/transfer-ownership/", workspace_transfer_ownership_api, name="workspace-transfer-ownership"),
