...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(condition=Q(requested_check_out_date__isnull=True) | Q(requested_check_in_date__isnull=True) | Q(requested_check_out_date__gte=F("requested_check_in_date")), name="application_dates_valid"),
        ),
        migrations.AddConstraint(
            model_name="application",
            constraint=models.UniqueConstraint(condition=Q(status__in=["draft", "submitted", "under_review"]), fields=["workspace", "applicant", "property"], name="application_active_applicant_property_uniq"),
        ),
        migrations.AddConstraint(
            model_name="applicationevent",
            constraint=models.UniqueConstraint(fields=["application", "event_key"], name="application_event_key_uniq"),
        ),
        migrations.RunSQL(
            sql="""
