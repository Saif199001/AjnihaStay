...
def apply_rls(apps, schema_editor):
    ...
    with schema_editor.connection.cursor() as cursor:
        ...
        cursor.execute(
            "DROP POLICY IF EXISTS workspace_isolation_payments_billingschedule "
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["active", "next_run_date"],
                        name="payments_bi_active_674fd1_idx",
                    ),
                    models.Index(
                        fields=["occupancy"],
                        name="payments_bi_occupan_136be4_idx",
                    ),
                ],
                "constraints": [
