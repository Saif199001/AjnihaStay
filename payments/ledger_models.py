...
class FinancialLedgerEntry(models.Model):
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=["workspace", "event_type"], name="payments_fl_eventtype_3e6a91_idx"),
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name="financial_ledger_workspace_event_key_unique",
            ),
            models.CheckConstraint(
                condition=Q(amount__isnull=True) | Q(amount__gt=0),
                name="financial_ledger_amount_positive",
            ),
        ]
