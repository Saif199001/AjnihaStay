...
INSTALLED_APPS = [
    ...
    "django.contrib.messages", "django.contrib.staticfiles", "accounts", "workspaces", "properties", "unit",
    "tenant", "leasing", "payments", "kyc", "applications", "cloudinary", "cloudinary_storage", "dashboard",
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {"anon": os.getenv("DRF_ANON_THROTTLE_RATE", "5/min"), "user": os.getenv("DRF_USER_THROTTLE_RATE", "60/min")},
}
MIDDLEWARE = [
...
DATABASES = {"default": {"ENGINE": "django.db.backends.postgresql", "NAME": tmp_postgres.path.lstrip("/"), "USER": tmp_postgres.username, "PASSWORD": tmp_postgres.password, "HOST": tmp_postgres.hostname, "PORT": tmp_postgres.port, "OPTIONS": dict(parse_qsl(tmp_postgres.query)), "ATOMIC_REQUESTS": DB_RLS_ENABLED}}
...
cloudinary.config(cloud_name=os.getenv("MEDIA_CLOUD_NAME"), api_key=os.getenv("MEDIA_API_KEY"), api_secret=os.getenv("MEDIA_SECRET_KEY"))
DEFAULT_FILE_STORAGE = "cloudinary_storage.storage.MediaCloudinaryStorage"
STATICFILES_STORAGE = "whitenoise.storage.CompressedManifestStaticFilesStorage"
SIMPLE_JWT = {"ACCESS_TOKEN_LIFETIME": timedelta(minutes=int(os.getenv("JWT_ACCESS_TOKEN_MINUTES", "15"))), "REFRESH_TOKEN_LIFETIME": timedelta(days=int(os.getenv("JWT_REFRESH_TOKEN_DAYS", "7"))), "AUTH_HEADER_TYPES": ("Bearer",), "USER_ID_FIELD": "id", "USER_ID_CLAIM": "user_id", "ROTATE_REFRESH_TOKENS": True, "BLACKLIST_AFTER_ROTATION": True, "UPDATE_LAST_LOGIN": False}
